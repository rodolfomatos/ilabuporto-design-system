...
function Sidebar({ items, activeKey, onSelect, header, footer, className, width = "w-56", isOpen = true, onClose }) {
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("nav", { className: "p-3 space-y-1 flex-1 overflow-y-auto", children: items.map((item) => /* @__PURE__ */ jsxRuntime.jsxs(
            "button",
            {
              ...
              children: [
                ...
                item.label,
                item.badge !== void 0 && item.badge > 0 && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "ml-auto px-2 py-0.5 text-xs font-medium text-white bg-red-600 dark:bg-red-500 rounded-full", children: item.badge })
              ]
            },
            item.key
          )) }),
    ...
    isOpen && onClose && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "fixed inset-0 bg-black/50 z-30 md:hidden", onClick: () => onClose() })
  ] });
}
