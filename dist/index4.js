...
function Brand({ name, hideSeparator = false, footer = false, className, href }) {
  ...
  if (footer) {
    return /* @__PURE__ */ jsxs("div", { className, children: [
      img,
      name && /* @__PURE__ */ jsx("p", { className: "text-sm leading-relaxed text-white/70 dark:text-gray-400", children: name })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: cn("flex items-center min-w-0", className), children: [
